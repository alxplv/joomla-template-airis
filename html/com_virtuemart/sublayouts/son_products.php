...
$sublayoutPrefix = 'airis_'; // Make this sublayout override compatible with airis sublayouts
	...
	<?php foreach ($viewData['products'] as $products) : ?>
		...
		<?php foreach ($products as $product) : ?>
			...
			<div class="product-container virtuemart-product browse-view-product airis-flex-item-per-row-<?php echo $productsPerRow; ?> browse-view-product-per-row-<?php echo $productsPerRow; ?> airis-flex airis-flex-column<?php echo $productMarkerClasses; ?>" data-vm="product-container">
				...
				<div class="virtuemart-product-title browse-view-product-title airis-flex">
					<?php echo HTMLHelper::link($productHref, $productName, array('class' => 'virtuemart-product-title-link browse-view-product-title-link default-shadow')); ?>
				</div>
				...
				<?php if (!empty(trim($product->product_sku))) : ?>
					<div class="virtuemart-product-sku browse-view-product-sku">
						...
						<div class="virtuemart-product-sku-title browse-view-product-sku-title default-shadow">
							<?php echo vmText::_('SON_COM_VIRTUEMART_PRODUCT_SKU_TITLE'); ?>
						</div>

						<div class="virtuemart-product-sku-content browse-view-product-sku-content default-shadow">
				...
				<?php if (isset($product->customfieldsSorted[$customFieldsPositionAddtocartBeforeName])) : ?>
					<div class="virtuemart-product-custom-fields-position virtuemart-product-custom-fields-position-<?php echo $customFieldsPositionAddtocartBeforeName; ?> browse-view-product-custom-fields-position browse-view-product-custom-fields-position-<?php echo $customFieldsPositionAddtocartBeforeName; ?>">
						<?php echo shopFunctionsF::renderVmSubLayout('son_customfields', array('product' => $product, 'position' => $customFieldsPositionAddtocartBeforeName)); ?>
					</div>
				<?php endif; ?>

				<?php if (!empty($product->product_s_desc)) : ?>
					<div class="virtuemart-product-description-short browse-view-product-description-short">

						<div class="virtuemart-product-description-short-title browse-view-product-description-short-title">
							<?php echo Text::_('SON_COM_VIRTUEMART_PRODUCT_DESCRIPTION_SHORT_TITLE'); ?>
						</div>

						<div class="airis-item-content virtuemart-description virtuemart-product-description-short-content browse-view-product-description-short-content">
				...
				<?php if (isset($product->customfieldsSorted[$customFieldsPositionAddtocartAfterName])) : ?>
					<div class="virtuemart-product-custom-fields-position virtuemart-product-custom-fields-position-<?php echo $customFieldsPositionAddtocartAfterName; ?> browse-view-product-custom-fields-position browse-view-product-custom-fields-position-<?php echo $customFieldsPositionAddtocartAfterName; ?>">
						<?php echo shopFunctionsF::renderVmSubLayout('son_customfields', array('product' => $product, 'position' => $customFieldsPositionAddtocartAfterName)); ?>
					</div>
				<?php endif; ?>

				<div class="virtuemart-product-links browse-view-product-links">
					<?php echo HTMLHelper::link($productHref, vmText::_('COM_VIRTUEMART_PRODUCT_DETAILS'), array('class' => 'virtuemart-product-link virtuemart-product-details-link browse-view-product-details-link btn')); ?>
				</div>
