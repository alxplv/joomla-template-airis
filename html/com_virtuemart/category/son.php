...
// Controls the display of custom optional disclaimers defined using language overrides
...
$sublayoutPrefix = 'airis_'; // Make this tempalte override compatible with airis sublayouts
...
if (vRequest::getInt('dynamic', 0) && vRequest::getInt('virtuemart_product_id', 0)) {
	...
	if (!empty($this->products))
	{
		...
		echo shopFunctionsF::renderVmSubLayout('son_products', array('products' => $this->products, 'currency' => $this->currency, 'products_per_row' => $this->perRow, 'showRating' => $this->showRating, 'airis-template-options' => $airisTemplateOptions));
	}
