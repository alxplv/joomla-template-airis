                    ...
                    if (addedProductsStatusText) {
                        ...
                        if (errorHappened) {
                            ...
                            if (confirm(addedProductsStatusText)) {
                                if (Joomla.getOptions("tpl_airis").vmCartUri === "undefined") {
                                    // Fallback to non-SEF cart URI but it seems to be broken in Joomla! 4+ (doesn't route you to the cart view menu item)
                                    location.href = "/index.php?option=com_virtuemart&view=cart";
                                } else {
                                    location.href = Joomla.getOptions("tpl_airis").vmCartUri;
                                }
                            }
                        }
                    } else {
